# EECS 151/251A ASIC Lab 1: Simulation
<p align="center">
Prof. Sophia Shao
</p>
<p align="center">
...
[Skywater 130nm Process Design Kit](https://skywater-pdk.readthedocs.io/en/latest/). <!---tech-->
...
[Sky130 Tutorial](https://chipyard.readthedocs.io/en/dev/VLSI/Sky130-Tutorial.html) <!---tech-->
...
**Note: The Hammer plugins are provided to us solely for educational use. They should NEVER be copied outside of instructional machines under any circumstances, or else we risk losing access in the future!!!**  <!---tech-->
...
The above text describes the delay for a cell of type `sky130_fd_sc_hd__inv_2` for the instance `add0/g816`. <!---tech-->
