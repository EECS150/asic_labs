...
`build/par-rundir/gcd_coprocessor.PVT_0P63V_100C.par.spef` <!---tech-->
...
(`syn-rundir/reports/final_time_PVT_0P63V_100C.setup_view.rpt`) <!---tech-->
...
Navigate to 
`build/power-rundir/activePowerReports.PVT_0P63V_100C.setup_view/`and open `power.rpt`. <!---tech-->
