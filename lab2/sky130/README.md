# EECS 151/251A ASIC Lab 2: Logic Synthesis
<p align="center">
Prof. Bora Nikolic
</p>
<p align="center">
...
`final_time_ss_100C_1v60.setup_view.rpt`. <!---tech-->
...
Since our critical path meets the timing requirements with a 212 ps of slack, this means we can run this synthesized design with a period equal to clock period (5000 ps) minus the critical path slack (212 ps), which is 4788 ps. <!---tech-->
