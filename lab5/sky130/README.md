...
The Sky130 PDK does not come with SRAMs by default, so a former undergraduate (now graduate student) Rahul Kumar wrote an SRAM generator (mostly from scratch) to create these SRAM macros. <!---tech-->
They are located at:
