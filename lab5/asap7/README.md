...
The ASAP7 PDK does not come with SRAMs by default, so a graduate student (Sean Huang) graciously created some dummy models for us to use. <!---tech-->
They are located at:
...
*i) In ASAP7, there are 9 metal layers, but realistically only 7 layers to route on in order to leave the top 2 layers for robust power distribution, as you saw in Lab 4.* <!---tech-->
...
<p align="center">
<img src="/lab5/figs/layout.png" width="400" /> <!---tech-->
</p>
...
- Pre-calculate valid locations for the macros. This will involve:
  ...
  (e.g. 18.848um × 19.296um for `SRAM2RW16x16`) <!---tech-->
...
`/home/ff/eecs151/asic/technology/asap7/asap7PDK_r1p7/docs/asap7_drm.pdf`. <!---tech-->
...
b) Skim through Chapter 1.2 of the DRM (`/home/ff/eecs151/asic/technology/asap7/asap7PDK_r1p7/docs/asap7_drm.pdf`). <!---tech-->
